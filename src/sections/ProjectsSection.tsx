...
export default function ProjectsSection() {
  return (
    <section
      id="projects"
      className="rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] -mt-10 sm:-mt-12 md:-mt-14 relative z-10 px-5 sm:px-8 md:px-10 pt-20 sm:pt-24 md:pt-28 pb-32"
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div className="flex flex-col">
              ...
              <h3
                ...
                style={{ color: '#D7E2EA', fontSize: 'clamp(1.25rem, 3vw, 2.25rem)' }}
              >
                {project.name}
              </h3>
            </div>
